...
fun main() {
    try {
        ...
        */
        ...
        фор №3: так как стек, каждый раз выкидываем последний элемент и выводим его. всего элементов 9, хотим выкинуть 10: 3, 6, 8, 10, 12, 14, 16, 18, 20, Stack is empty!
        после удаления 9го элемента стек пустой, невозможно удалить 10 элемент -> пробрасывается исключение с соотв текстом ошибки
        */
        for (i in 20 downTo 0 step 2) {
            stack.push(i)
        }
